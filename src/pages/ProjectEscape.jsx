...
function ProjectEscape({ isOpen }){
	...
	useEffect(() => {
		document.title = `Escape the Lair - ${appTitle}`;
	}, []);
					...
					<div className="single-left">
						...
						<div className="single-links">
							<div className="view-link">
								<a href="https://github.com/atanhq/js-game" target="_blank">
								<img src={github} alt="view github" /> 
								<span>Github</span></a>
							</div>

							<div className="view-link">
								<a href="https://nanatan.com/escape/" target="_blank">
